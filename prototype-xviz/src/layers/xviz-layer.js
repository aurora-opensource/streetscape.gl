  ...
  renderLayers() {
      ...
      return new ScatterplotLayer(
        this.getSubLayerProps({
          ...
          updateTriggers: deepExtend(updateTriggers, {
            getColor: {useOdtacSemanticColor: this.props.useOdtacSemanticColor}
          })
        })
      );
    ...
    case 'polygon': {
      const props = this.getSubLayerProps({
        ...
        updateTriggers: deepExtend(updateTriggers, {
          getLineColor: {useOdtacSemanticColor: this.props.useOdtacSemanticColor},
          getFillColor: {useOdtacSemanticColor: this.props.useOdtacSemanticColor}
        })
      });
